...
- (void)drawRect:(__unused CGRect)rect
{
    ...
    if (_pointDirection == PointDirectionUp) {
        CGPathMoveToPoint(bubblePath, NULL, _targetPoint.x+_sidePadding, _targetPoint.y);//始点
        CGPathAddLineToPoint(bubblePath, NULL, _targetPoint.x+_sidePadding+_pointerSize, _targetPoint.y+_pointerSize);//直線
        ...
        CGPathAddLineToPoint(bubblePath, NULL, _targetPoint.x+_sidePadding-_pointerSize, _targetPoint.y+_pointerSize);//尖った部分
    }
    else {
    ...
    /*if (_pointDirection == PointDirectionUp) {
     ...
     self.backgroundColor=[UIColor colorWithRed:68/255.0 green:83/255.0 blue:95/255.0 alpha:1];
     }*/
...
#pragma clang diagnostic pop
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        CGFloat fullHeight = _bubbleSize.height+160 + _pointerSize + 10.0;
        CGFloat y_b;
        if (_pointDirection == PointDirectionUp) {
        ...
        finalFrame = CGRectMake(x_b-_sidePadding,
                                y_b,
                                _bubbleSize.width+130+_sidePadding*2,
                                fullHeight);
    }
    else{
        CGFloat fullHeight = _bubbleSize.height+90 + _pointerSize + 10.0;
        CGFloat y_b;
        if (_pointDirection == PointDirectionUp) {
            y_b = _topMargin + pointerY;
            _targetPoint = CGPointMake(x_p-x_b, 0);
        ...
        finalFrame = CGRectMake(x_b-_sidePadding,
                                y_b,
                                _bubbleSize.width+65+_sidePadding*2,
                                fullHeight);
    }
...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame])) {
        ...
        self.backgroundColor = [UIColor colorWithRed:0/255.0 green:143/255.0 blue:88/255.0 alpha:1];
        self.has3DStyle = YES;
